<template><page class="page">
  <panel class="panel1" uid="0">
    ...
    <content-block uid="1">
      <p>
        is a framework for building elearning solutions. Out of the box, Simple Learning offers:
      </p>
      <ul style="padding-left: 1rem;" class="local">
        ...
        <li>
          Branching nav structure
        </li>
        <li>
          Easy layout and styling tools
        </li>
        <li>
          One more time
        </li>
  ...
  <panel class="introText" v-if="showFinished() == false" uid="1">This Scorm 1.2 module contains two fully gated modules. Each module showcases various page types with interactivities. Chapter 3 contains assessment part. Upon completion of this module, user gets completion status and score.</panel>
  <panel class="panel2 menu" uid="2">
    ...
    <button class="finalMsg" v-if="showFinished() == true" @click="closeModule">
      <svg-container :src="handshake" class="bullseye"></svg-container><span class="bText">This module was successfully completed! Click to close this module.</span>
    </button>
  </panel>
